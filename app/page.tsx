...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-white-50 to-accent-100 bg-cover bg-center w-full">
      <HeaderHome />
      <section 
        className="flex flex-col items-center w-full px-4 sm:px-6 md:px-8 lg:px-28 pt-28  lg:pt-24 pb-6"
        aria-label="Héros"
      >
        <div className="flex flex-col lg:flex-row w-full   justify-between gap-8 sm:gap-12 md:gap-14 lg:gap-8">
          {/* Contenu texte */}
          <div className="flex flex-col gap-6 sm:gap-8 text-center lg:text-start md:gap-10 lg:my-auto order-2 lg:order-1">
            <h1 
            ...
            <p className="font-regular font-inter text-base mx-auto lg:mx-0 sm:text-paragraph-lg text-black-400 max-w-none sm:max-w-lg md:max-w-xl">
